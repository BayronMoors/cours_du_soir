...
let chronoStart;
let chronoTotal;
let currentWordReplace;
let wrongLetter;
const resetGame = () => {
    const h = document.querySelectorAll("#hangm_guessbox, #hangm_guesses, #hangm_2, #hangm_1, #hangm_3, #hangm_4, #hangm_5, #hangm_6");
    h.forEach((item) => {
